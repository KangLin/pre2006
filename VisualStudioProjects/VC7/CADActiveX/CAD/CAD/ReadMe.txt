========================================================================
    ACTIVEX CONTROL DLL : CAD Project Overview
========================================================================

ControlWizard has created this project for your CAD ActiveX Control
...
that make up your CAD ActiveX Control DLL.
...
CAD.ico
    ...
    is included by the main resource file CAD.rc.

/////////////////////////////////////////////////////////////////////////////
CCADCtrl control:

CADCtrl.h
    This file contains the declaration of the CCADCtrl C++ class.

CADCtrl.cpp
    This file contains the implementation of the CCADCtrl C++ class.

CADPropPage.h
    This file contains the declaration of the CCADPropPage C++ class.

CADPropPage.cpp
    This file contains the implementation of the CCADPropPage C++ class.

CCADCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CCADCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file CAD.rc.
...
stdafx.h, stdafx.cpp
    ...
    named CAD.pch and a precompiled types (PCT) file named stdafx.obj.
