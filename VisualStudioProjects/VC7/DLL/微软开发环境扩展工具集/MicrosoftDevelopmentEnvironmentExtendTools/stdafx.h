...
#define IfFailRetrun(x, p) {if (FAILED(x)) return FALSE; if(!p) {return FALSE; }}

class DECLSPEC_UUID("4AC05046-DF4F-48C4-A3C0-951D95DAC83A") MicrosoftDevelopmentEnvironmentExtendToolsLib;
...
public:
	...
	DECLARE_LIBID(__uuidof(MicrosoftDevelopmentEnvironmentExtendToolsLib))
