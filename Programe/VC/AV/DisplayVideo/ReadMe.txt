========================================================================
		ActiveX Control DLL : DISPLAYVIDEO
========================================================================

ControlWizard has created this project for your DISPLAYVIDEO ActiveX Control
...
that make up your DISPLAYVIDEO ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
DisplayVideo control:

DisplayVideoCtl.h
	This file contains the declaration of the CDisplayVideoCtrl C++ class.

DisplayVideoCtl.cpp
	This file contains the implementation of the CDisplayVideoCtrl C++ class.

DisplayVideoPpg.h
	This file contains the declaration of the CDisplayVideoPropPage C++ class.

DisplayVideoPpg.cpp
	This file contains the implementation of the CDisplayVideoPropPage C++ class.

DisplayVideoCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDisplayVideoCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DisplayVideo.rc.
