========================================================================
		ActiveX Control DLL : VIDEOCTRL
========================================================================

ControlWizard has created this project for your VIDEOCTRL ActiveX Control
...
that make up your VIDEOCTRL ActiveX Control DLL.
...
VideoCtl.h
	This file contains the declaration of the CVideoCtrl C++ class.

VideoCtl.cpp
	This file contains the implementation of the CVideoCtrl C++ class.

VideoPpg.h
	This file contains the declaration of the CVideoPropPage C++ class.

VideoPpg.cpp
	This file contains the implementation of the CVideoPropPage C++ class.

VideoCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CVideoCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file VideoCtrl.rc.
