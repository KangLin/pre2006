// VCExtendTools.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include <initguid.h>
#include "VCExtendTools.h"
#include "DSAddIn.h"
#include "Commands.h"
...
class CVCExtendToolsApp : public CWinApp
{
public:
	CVCExtendToolsApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CVCExtendToolsApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CVCExtendToolsApp)
...
BEGIN_MESSAGE_MAP(CVCExtendToolsApp, CWinApp)
	//{{AFX_MSG_MAP(CVCExtendToolsApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CVCExtendToolsApp object

CVCExtendToolsApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CVCExtendToolsApp construction

CVCExtendToolsApp::CVCExtendToolsApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CVCExtendToolsApp initialization

BOOL CVCExtendToolsApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CVCExtendToolsApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_VCEXTENDTOOLS_DESCRIPTION);
