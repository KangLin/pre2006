...
#if !defined(AFX_COMMANDS_H__4344780B_3106_4B2A_9898_1BD8DA41FE88__INCLUDED_)
#define AFX_COMMANDS_H__4344780B_3106_4B2A_9898_1BD8DA41FE88__INCLUDED_

#include "VCExtendToolsTypes.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_VCExtendTools>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_VCExtendTools, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_VCExtendTools, 
...
public:
// ICommands methods
	STDMETHOD(VCExtendToolsCommandMethod)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__4344780B_3106_4B2A_9898_1BD8DA41FE88__INCLUDED)
