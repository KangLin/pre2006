========================================================================
       DEVELOPER STUDIO ADD-IN : VCExtendTools
========================================================================


The Add-in Wizard has created this VCExtendTools DLL for you.  This DLL not only
...
make up your VCExtendTools DLL.


VCExtendTools.h
	This is the main header file for the DLL.  It declares the
	CVCExtendToolsApp class.

VCExtendTools.cpp
	This is the main DLL source file.  It contains the class CVCExtendToolsApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (VCExtendToolsCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named VCExtendTools.pch and a precompiled types file named StdAfx.obj.
