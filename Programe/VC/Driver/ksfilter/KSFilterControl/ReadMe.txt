========================================================================
    STATIC LIBRARY : KSFilterControl Project Overview
========================================================================

AppWizard has created this KSFilterControl library project for you. 

This file contains a summary of what you will find in each of the files that
make up your KSFilterControl application.


KSFilterControl.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named KSFilterControl.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "KSFilterControl.rc" and a "KSFilterControl.h" that 
