// 中国象棋.cpp : Defines the class behaviors for the application.
//
...
BOOL CChessApp::InitInstance()
{
	...
	m_DeskDocTemp = new CMultiDocTemplate(
		IDR_DESKVIEW_TMPL,
		RUNTIME_CLASS(CChessDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CDeskView));
	AddDocTemplate(m_DeskDocTemp);	

	m_ChessDocTemp = new CMultiDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CChessDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CChessView));
	AddDocTemplate(m_ChessDocTemp);
