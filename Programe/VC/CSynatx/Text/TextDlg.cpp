...
void CTextDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_LIST1, m_lstClass);
	//}}AFX_DATA_MAP	
}
...
BOOL CTextDlg::OnInitDialog()
{
	...
	m_Synatx.LoadCode(_T("TEXTDLG.h"));
...
void CTextDlg::OnBnClickedButton1()
{
	...
	if(fd.DoModal() == IDOK)
	{
		//m_Synatx.LoadCode(fd.GetFileName());
		m_Synatx.LoadKeyWord(fd.GetFileName());
	} // ½áÊø if(fd.DoModal() == IDOK)	
}
