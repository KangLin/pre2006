========================================================================
       DEVELOPER STUDIO ADD-IN : MicrosoftDevelopmentEnvironmentExtendTools
========================================================================


The Add-in Wizard has created this MicrosoftDevelopmentEnvironmentExtendTools DLL for you.  This DLL not only
...
make up your MicrosoftDevelopmentEnvironmentExtendTools DLL.


MicrosoftDevelopmentEnvironmentExtendTools.h
	This is the main header file for the DLL.  It declares the
	CMicrosoftDevelopmentEnvironmentExtendToolsApp class.

MicrosoftDevelopmentEnvironmentExtendTools.cpp
	This is the main DLL source file.  It contains the class CMicrosoftDevelopmentEnvironmentExtendToolsApp.
	It also contains the OLE entry points required of inproc servers.

MicrosoftDevelopmentEnvironmentExtendTools.dsp
    This file (the project file) contains information at the project level and
    is used to build a single project or subproject. Other users can share the
    project (.dsp) file, but they should export the makefiles locally.

MicrosoftDevelopmentEnvironmentExtendTools.odl
    This file contains the Object Description Language source code for the
    type library of your DLL.

MicrosoftDevelopmentEnvironmentExtendTools.rc
    This is a listing of all of the Microsoft Windows resources that the
    program uses.  It includes the sample toolbar bitmap that is stored
    in the RES subdirectory.  This file can be directly edited in Microsoft
	Developer Studio.

res\MicrosoftDevelopmentEnvironmentExtendTools.rc2
    This file contains resources that are not edited by Microsoft 
	Developer Studio.  You should place all resources not
	editable by the resource editor in this file.

MicrosoftDevelopmentEnvironmentExtendTools.def
    This file contains information about the DLL that must be
    provided to run with Microsoft Windows.  It defines parameters
    such as the name and description of the DLL.  It also exports
	functions from the DLL.

MicrosoftDevelopmentEnvironmentExtendTools.clw
...
Commands.cpp, Commands.h
    ...
    a sample command (MicrosoftDevelopmentEnvironmentExtendToolsCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named MicrosoftDevelopmentEnvironmentExtendTools.pch and a precompiled types file named StdAfx.obj.
