...
#if !defined(AFX_STDAFX_H__11F6748E_E260_47B2_84CC_4035C8A20A50__INCLUDED_)
#define AFX_STDAFX_H__11F6748E_E260_47B2_84CC_4035C8A20A50__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in MicrosoftDevelopmentEnvironmentExtendTools.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__11F6748E_E260_47B2_84CC_4035C8A20A50__INCLUDED)
